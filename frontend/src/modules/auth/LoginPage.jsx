    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-stone-50 via-white to-stone-100">
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          ...
          {/* Demo Credentials */}
          <div className="mt-8 animate-fade-up rounded-2xl border border-stone-200/80 bg-gradient-to-br from-white/60 to-white/40 p-4 backdrop-blur-sm" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono text-sm font-medium text-primary bg-primary/5 px-3 py-1 rounded-lg">
                  demo@learning.os
                </span>
              </div>
              <div className="flex items-center justify-between">
          ...
          {/* Trust badges */}
          <div className="mt-8 animate-fade-up text-center" style={{ animationDelay: '0.3s' }}>
